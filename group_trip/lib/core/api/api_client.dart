...
class ApiClient {
  ...
  Future<Response> postWithParams(String serviceKey, String path, {Map<String, dynamic>? queryParameters, dynamic data}) {
    final dio = _dioFor(serviceKey);
    // ignore: avoid_print
    print('➡️ [ApiClient] POST service=$serviceKey path=$path query=$queryParameters data=$data base=${dio.options.baseUrl}');
  ...
  Future<Response> putWithParams(String serviceKey, String path, {Map<String, dynamic>? queryParameters, dynamic data}) {
    final dio = _dioFor(serviceKey);
    // ignore: avoid_print
    print('➡️ [ApiClient] PUT service=$serviceKey path=$path query=$queryParameters data=$data base=${dio.options.baseUrl}');
